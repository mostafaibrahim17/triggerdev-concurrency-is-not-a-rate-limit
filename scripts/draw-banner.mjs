...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 260" width="1200" height="260" role="img" aria-labelledby="t d">
  ...
  <g font-family="ui-monospace, SFMono-Regular, Menlo, monospace">
    ...
    <text x="64" y="140" font-size="44" font-weight="600" fill="#e6edf3">concurrencyLimit</text>
    <text x="64" y="192" font-size="44" font-weight="600" fill="#8b949e">is not a rate limit</text>
    <text x="64" y="228" font-size="15" fill="#6e7681">10,000 lookups &#183; a vendor allowing 5 req/s &#183; measured in DEV and PROD</text>
  </g>
  <g font-family="ui-sans-serif, system-ui, sans-serif">
    <line x1="720" y1="${y(5).toFixed(1)}" x2="1150" y2="${y(5).toFixed(1)}" stroke="#6e7681" stroke-dasharray="4 4" stroke-width="1.2"/>
    <text x="1150" y="${(y(5) - 8).toFixed(1)}" text-anchor="end" font-size="11" fill="#6e7681">vendor allows 5 req/s</text>
    <path d="${path(DEV)}" fill="none" stroke="#6e7681" stroke-width="2.4" stroke-dasharray="5 3"/>
    ...
    <text x="1150" y="${(y(3.70) + 22).toFixed(1)}" text-anchor="end" font-size="12" font-weight="600" fill="#8b949e">DEV, 74%</text>
